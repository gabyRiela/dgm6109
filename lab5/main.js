...
function processForm() {
    ...
    /*Choices: glasses elephant, bubbles Fish, mask Panda, Drummer Drumming, Duck to Goose */
    let specialChoice1 = document.getElementById("specialChoice1").value;
    let specialChoice2 = document.getElementById("specialChoice2").value;

    drawing.selectAll('svg>*').remove();
    makeDrawing(drawing, choice1, x1, y1, choice2, x2, y2, showOrigin, specialChoice1, specialChoice2);
}
...
function makeDrawing(canvas, choice1, x1, y1, choice2, x2, y2, showOrigin, specialChoice1, specialChoice2) {

    let item1 = canvas.append("g");
    if (choice1 == "elephant") {
        elephant(item1, x1, y1, showOrigin, specialChoice1);
    } else if (choice1 == "fish") {
        fish(item1, x1, y1, showOrigin, specialChoice1);
        ...
        panda(item1, x1, y1, showOrigin, specialChoice1);
    } else if (choice1 == "caterpillar") {
        caterpillar(item1, x1, y1, showOrigin);
    } else if (choice1 == "drummer") {
        drummer(item1, x1, y1, showOrigin, specialChoice1);
    } else if (choice1 == "duck") {
        duck(item1, x1, y1, showOrigin, specialChoice1);
    }else if (choice1 == "ladybug") {
        ladybug(item1, x1, y1, showOrigin, specialChoice1);
    }else if (choice1 == "rooster") {
        rooster(item1, x1, y1, showOrigin, specialChoice1);
    }else if (choice1 == "trumpeter") {
        trumpeter(item1, x1, y1, showOrigin, specialChoice1);
    }else{ (choice1 == "dog") 
    ...
    if (choice2 == "elephant") {
        elephant(item2, x2, y2, showOrigin, specialChoice2);
    } else if (choice2 == "fish") {
        fish(item2, x2, y2, showOrigin, specialChoice2);
        ...
        panda(item2, x2, y2, showOrigin, specialChoice2);
    } else if (choice2 == "caterpillar") {
        caterpillar(item2, x2, y2, showOrigin);
    } else if (choice2 == "drummer") {
        drummer(item2, x2, y2, showOrigin, specialChoice2);
    } else if (choice2 == "duck") {
        duck(item2, x2, y2, showOrigin, specialChoice2);
    }else if (choice2 == "ladybug") {
        ladybug(item2, x2, y2, showOrigin, specialChoice2);
    }else if (choice2 == "rooster") {
        rooster(item2, x2, y2, showOrigin, specialChoice2);
    }else if (choice2 == "trumpeter") {
        trumpeter(item2, x2, y2, showOrigin, specialChoice2);
    }else {(choice2 == "dog")
