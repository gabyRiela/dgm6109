...
let datasetOriginal = [
    ...
    { date: "2025-10-21", activeKcal: 343, energyEnd: undefined, energyMorning: 2, energyAfter: 3 },
...
/* Remove incomplete data (where energyEnd is undefined)
   This ensures we only plot workouts with complete energy data */
let dataset = datasetOriginal.filter(function (value) {
    return value.energyEnd !== undefined;
});
